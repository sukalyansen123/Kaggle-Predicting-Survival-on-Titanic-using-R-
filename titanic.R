setwd("/home/sukalyan/Desktop/kaggle/")
...
# replacing qualitative variables sex by quantitative variable 

trainData$Sex=gsub("female",1,trainData$Sex)
trainData$Sex=gsub("male",0,trainData$Sex)

# filling up unfilled ages by using titles like Mr,Mrs,etc
...
#renaming the name values for simplicity
...
#calculating average age for all classes
...
mr_age = round(mean(trainData$Age[trainData$Name == "Mr"], na.rm = TRUE))
dr_age = round(mean(trainData$Age[trainData$Name == "Dr"], na.rm = TRUE))
 
#filling up unfilled ages
...
#person being child,mother may affect survival 
...
#applying Generalized Linear Model with family binomial as this being ogistic regression
